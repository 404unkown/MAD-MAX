...
async function lockgcCommand(client, chatId, message, args, sender, pushName, isOwner) {
    try {
        ...
        console.log(`[LOCKGC] Group ${chatId} locked by ${sender}`);
